...
This blog post includes the step-by-step details of an Interactive Waffles code-through. A Shiny-enabled version is also available [here](https://castower.shinyapps.io/Code-Through-Project-Stowers/#section-introduction).
